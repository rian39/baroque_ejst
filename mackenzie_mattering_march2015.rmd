...
```{r gibbs_normal_bivar, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, comment=NA} 
...
```{r  distributions, echo=FALSE, message=FALSE, warning=FALSE, fig.cap=''} 
...
```{r metrohast_normal, echo=FALSE, fig.cap=''} 
